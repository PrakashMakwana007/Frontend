...
const StatCard = ({ icon, label, value, onClick }) => (
  <motion.div
    ...
    className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow flex items-center gap-4 cursor-pointer hover:shadow-lg transition-all"
